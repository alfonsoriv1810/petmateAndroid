...
public class ADZoomView extends FrameLayout {
    ...
    public ADZoomView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ADZoomView(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public ADZoomView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void dispatchDraw(final Canvas canvas) {
        ...
        //
        final boolean animating = Math.abs(zoom - smoothZoom) > 0.0000001f|| Math.abs(zoomX - smoothZoomX) > 0.0000001f || Math.abs(zoomY - smoothZoomY) > 0.0000001f;
